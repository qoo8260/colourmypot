...
if($_SESSION['login'] != "yes")
{
    ...
    $url="https://app.getoccasion.com/api/v1/orders?include=occurrences&page[size]=100";
...
<!-- ==============================================================================container -->
  ...
  <br>
  		<h4>Select Two Dates (Interval)</h4><hr>
  ...
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Date from</span>
  </div>
  <input type="text" placeholder="Available from" class="form-control is-invalid" name="fromavailable" id="datepicker1">    
      	...
      	<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Date to</span>
  </div>
  <input type="text" placeholder="Available until" class="form-control is-invalid" name="toavailable" id="datepicker2">    
		...
		<div class="input-group mb-3">
  		        ...
  		        <input type="button" value="Search" class="form-control" id="submitbutton">
  

  </div>	
             <input type="hidden" id="showtablevisibility">
...
<script type="text/javascript">
        ...
        var date_input1=$('input[name="fromavailable"]');
        var date_input2=$('input[name="toavailable"]');
	...
	$('#submitbutton').click(function(){
		...
		{
			cnt++;
			alert("You cannot leave date (Date from) field empty");
		}
		...
		{
			cnt++;
			alert("You cannot leave date (Date to) field empty");
		}
    ...
    var resultOfDate = custdetails.filter( obj => obj.duedate >= $('#datepicker1').val());
    resultOfDate = resultOfDate.filter( obj => obj.duedate <= $('#datepicker2').val());
