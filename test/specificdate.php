...
<!-- ==============================================================================container -->
  ...
  <br>
  		<h4>Select One Specific Date</h4><hr>
  ...
  <input type="text" placeholder="Select Date" class="form-control is-invalid" name="fromavailable" id="datepicker1">    
...
<script type="text/javascript">
	...
	$('#submitbutton').click(function(){
		...
		{
			cnt++;
			alert("You cannot leave date field empty");
		}
