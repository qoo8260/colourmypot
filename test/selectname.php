...
<!-- ==============================================================================container -->
  ...
  <input type="text" placeholder="First Name" class="form-control is-invalid" name="fromavailable" id="firstnameid">    
  ...
  <input type="text" placeholder="Last Name" class="form-control is-invalid" name="toavailable" id="lastnameid">    
...
<script type="text/javascript">
	...
	$('#submitbutton').click(function(){
		...
		{
			cnt++;
			alert("You cannot leave date first name field empty");
		}	
		else if($('#lastnameid').val() == "")
		{
			cnt++;
			alert("You cannot leave date last name field empty");
		}
    ...
    var tablefirstname=$("#firstnameid").val();
    var tablelastname=$("#lastnameid").val();
            
            
            
            
    tablefirstname = tablefirstname.replace(/\s+/g, '');
    tablelastname = tablelastname.replace(/\s+/g, '');

            
    //console.log(tablefirstname.toUpperCase());        
    //console.log(tablelastname.toUpperCase());        
    var resultOfDate = custdetails.filter( obj => obj.first ===  tablefirstname.toUpperCase());
    resultOfDate = resultOfDate.filter( obj => obj.last ===  tablelastname.toUpperCase());
