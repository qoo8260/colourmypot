...
<?php
    ...
    for($i=9;$i>-1;$i--)
    {
        ...
        $payment=$array["data"][$i]["attributes"]["payment_status"];
        $booking=$array["data"][$i]["attributes"]["status"];
        
        if($payment=="completed" && $booking=="booked")
        {
            
            
            $email=$array["data"][$i]["attributes"]["customer_email"];
            $name=$array["data"][$i]["attributes"]["customer_name"];
            $first_name=$array["data"][$i]["attributes"]["customer_first_name"];
            $last_name=$array["data"][$i]["attributes"]["customer_last_name"];
            $password=$array["data"][$i]["id"];
            $zip=$array["data"][$i]["attributes"]["customer_zip"];
            $quantity=$array["data"][$i]["attributes"]["quantity"];
            $tax=$array["data"][$i]["attributes"]["tax"];
            $price=$array["data"][$i]["attributes"]["price"];
            $description=$array["data"][$i]["attributes"]["description"];
            $created_time=$array["data"][$i]["attributes"]["created_at"];
